...
public class FullscreenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent i=getIntent();
        imagePosition=i.getIntExtra("ImagePosition",-1);
        mVisible = true;
        ...
        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent=new Intent(FullscreenActivity.this,OCRActivity.class);
        ...
        imageView= (PhotoView) mContentView;
        imageView.enable();
        imageView.disableRotate();
